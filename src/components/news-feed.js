...
function NewsFeed() {
    let comments = [
        { content: "This is my post using functional components", username: "Jeff", date: "January 31, 2022" },
    ...
    return (
        <div className="container">
            <Post {...{comments: comments, content: "This is my post content inside the functional component"}} />
